...
public class studentTokens {
	...
	private static void transferSTEMToken(AccountId student, AccountId supervisor) {
	...
	public static void main(String[] args) throws Exception {
        ...
        if(create.equals("Y") || create.equals("y")) {
        	...
        	System.out.println("The address of your NFT image on the hashgraph is: " + newFileId);
        }
        ...
        System.out.println("The new account ID is: " +studentAccountId);
        ...
        AccountBalance accountBalance = new AccountBalanceQuery()
        	...
        	TransactionResponse sendHbar = new TransferTransaction()
                    ...
                    .addHbarTransfer(studentAccountId, Hbar.fromTinybars(1000))
                    .execute(client);
        ...
        AccountBalance accountBalanceNew = new AccountBalanceQuery()
            ...
            FileCreateTransaction transaction = new FileCreateTransaction()
            	...
            	FileCreateTransaction modifyMaxTransactionFee = transaction
               ...
               TokenCreateTransaction transactiontoken = new TokenCreateTransaction()
            	        ...
            	        .setTreasuryAccountId(studentAccountId)
            	        .setInitialSupply(1)
